...
def find_minimum_tokens_for_price(machine):
    ...
    return (
        ...
        and number_of_tokens_is_affordable(Pa, Pb)
...
def number_of_tokens_is_affordable(Pa, Pb):
    """More than 100 presses per button isn't fun anymore."""
    return Pa <= 100 and Pb <= 100
